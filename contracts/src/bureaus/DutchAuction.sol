...
import {LPNFTStakeFarm} from "../defi/LPNFTStakeFarm.sol";
  ...
  IDutchAuction
{
   ...
   */
  LPNFTStakeFarm public immutable lpNftStakeFarm;
  ...
  constructor(
    ...
    lpNftStakeFarm = LPNFTStakeFarm(lpNftStakeFarm_);
