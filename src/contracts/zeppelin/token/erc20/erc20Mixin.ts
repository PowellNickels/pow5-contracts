...
function ERC20Mixin<T extends new (...args: any[]) => {}>(Base: T) {
  return class extends Base {
    ...
    async transfer(to: string, value: bigint): Promise<void> {
    ...
    async approve(spender: string, value: bigint): Promise<void> {
    ...
    async transferFrom(from: string, to: string, value: bigint): Promise<void> {
